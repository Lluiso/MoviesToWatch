...
public class DetailActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_watchlist) {
            DBHelper DB = new DBHelper(this, "movieDB", null, 1);

            Cursor c = DB.findProduct(Titulo);
            if (c.getCount()== 0) {
                DB.addProduct(Titulo, Year, Image, Plot);
                Toast toast = Toast.makeText(this, "Movie added to Watchlist", Toast.LENGTH_LONG);
                toast.show();
            }
            else {
                Toast toast = Toast.makeText(this, "Movie already on Watchlist", Toast.LENGTH_LONG);
                toast.show();
            }
    ...
    public static class DetailFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (intent != null && intent.hasExtra("Año")) {
                Year = intent.getStringExtra("Año");
            ...
            if (intent != null && intent.hasExtra("Imagen")){
                ...
                new ImageLoadTask(Image,((ImageView) rootView.findViewById(R.id.imageView))).execute();
            }
